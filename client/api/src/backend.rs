...
use primitives::{offchain::OffchainStorage, ChangesTrieConfiguration};
use sp_blockchain;
use sp_runtime::{
	generic::BlockId,
...
use state_machine::{
	backend::Backend as StateBackend, ChangesTrieStorage as StateChangesTrieStorage,
	...
	H: Hasher<Out = Block::Hash>,
{
	...
	fn destroy_state(&self, _state: Self::State) -> sp_blockchain::Result<()> { Ok(()) }
