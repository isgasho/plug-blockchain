...
impl<B, E, Block, RA, F> ChainBackend<B, E, Block, RA> for LightChain<B, E, Block, RA, F>
where
...
{
	fn client(&self) -> &Arc<Client<B, E, Block, RA>> { &self.client }

	fn subscriptions(&self) -> &Subscriptions { &self.subscriptions }
