...
pub use crate::{
	...
	weights::{
		ClassifyDispatch, DispatchInfo, GetDispatchInfo, PaysFee, SimpleDispatchInfo,
		TransactionPriority, WeighBlock, WeighData, Weight,
	},
};
...
pub use sp_runtime::{
	traits::{DispatchResult, Dispatchable, ModuleDispatchError},
	DispatchError,
};
...
/// * `Call`: The enum generated for every module, which implements
...
mod tests {
	...
	use crate::{
		...
		sp_runtime::traits::{OnFinalize, OnInitialize},
	...
	pub mod system {
		...
		pub fn ensure_root<R>(_: R) -> Result { Ok(()) }
	}
	...
	fn on_initialize_should_work() { <Module<TraitImpl> as OnInitialize<u32>>::on_initialize(42); }

	#[test]
	#[should_panic(expected = "on_finalize")]
	fn on_finalize_should_work() { <Module<TraitImpl> as OnFinalize<u32>>::on_finalize(42); }
