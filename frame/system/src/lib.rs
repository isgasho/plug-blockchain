...
pub trait Trait: 'static + Eq + Clone {
	...
	type Origin: Into<Result<RawOrigin<Self::AccountId, Self::Doughnut>, Self::Origin>> + From<RawOrigin<Self::AccountId, Self::Doughnut>> + MaybeDoughnutRef<Doughnut=Self::Doughnut> + Clone;
...
pub struct EnsureSigned<AccountId, Doughnut>(sp_std::marker::PhantomData<(AccountId, Doughnut)>);
impl<
	O: Into<Result<RawOrigin<AccountId, Doughnut>, O>> + From<RawOrigin<AccountId, Doughnut>>,
	AccountId,
	Doughnut,
...
pub struct EnsureSignedBy<Who, AccountId, Doughnut>(sp_std::marker::PhantomData<(Who, AccountId, Doughnut)>);
impl<
	O: Into<Result<RawOrigin<AccountId, Doughnut>, O>> + From<RawOrigin<AccountId, Doughnut>>,
...
pub struct EnsureNone<AccountId, Doughnut>(::sp_std::marker::PhantomData<(AccountId, Doughnut)>);
impl<
	O: Into<Result<RawOrigin<AccountId, Doughnut>, O>> + From<RawOrigin<AccountId, Doughnut>>,
	AccountId,
	Doughnut,
...
pub fn ensure_root<OuterOrigin, AccountId, Doughnut>(o: OuterOrigin) -> Result<(), BadOrigin>
	where OuterOrigin: Into<Result<RawOrigin<AccountId, Doughnut>, OuterOrigin>>
{
	match o.into() {
...
pub fn ensure_none<OuterOrigin, AccountId, Doughnut>(o: OuterOrigin) -> Result<(), BadOrigin>
	where OuterOrigin: Into<Result<RawOrigin<AccountId, Doughnut>, OuterOrigin>>
{
	match o.into() {
